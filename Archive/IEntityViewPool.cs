...
// {
//     /// <summary>
//     /// Defines a pool for managing <see cref="IEntityView"/> instances.
//     /// Provides methods to rent, return, and clear pooled views to optimize memory and performance.
//     /// </summary>
//     public interface IEntityViewPool<in E> where E : IEntity
//     {
//         /// <summary>
...
//         /// <returns>An active <see cref="IEntityView"/> instance.</returns>
//         IEntityView Rent(string name);
//
//         /// <summary>
...
//         /// <param name="view">The <see cref="IEntityView"/> instance to return to the pool.</param>
//         void Return(string name, E view);
//
//         /// <summary>
