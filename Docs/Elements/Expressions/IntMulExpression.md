...
Represents an expression that computes the product of multiple
      ...
      <li>
        <details>
          ...
          <ul>
            ...
            <li><a href="#ctor-2">IntMulExpression(Func&lt;int&gt;[])</a></li>
            <li><a href="#ctor-3">IntMulExpression(IEnumerable&lt;Func&lt;int&gt;&gt;)</a></li>
          </ul>
        </details>
      </li>
      <li>
