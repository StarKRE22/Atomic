...
For full details on the source generators, see the [Code Generation Walkthrough](2.%20Entity%20API%20Generation.md) and the
...
For more advanced scenarios, see the [Code Generation Walkthrough](2.%20Entity%20API%20Generation.md).

---

<p align="center">
<a href="4.%20Architectural%20Consistency.md">Move Next</a> •
