...
namespace SampleGame
{
	...
	{
		///Values
		public const int MoneyView = 1244729972; // MoneyView
		public const int GameCountdownView = -1904794221; // GameCountdownView
		public const int PopupTransform = -129960303; // Transform
		public const int GameOverViewPrefab = 958868224; // GameOverView
		public const int GameOverView = 155828828; // GameOverView
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static GameCountdownView GetGameCountdownView(this IUIContext obj) => obj.GetValue<GameCountdownView>(GameCountdownView);

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool TryGetGameCountdownView(this IUIContext obj, out GameCountdownView value) => obj.TryGetValue(GameCountdownView, out value);

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void AddGameCountdownView(this IUIContext obj, GameCountdownView value) => obj.AddValue(GameCountdownView, value);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void SetGameCountdownView(this IUIContext obj, GameCountdownView value) => obj.SetValue(GameCountdownView, value);
