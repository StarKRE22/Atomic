...
namespace Atomic.Events
{
        ...
        where TBus : IEventBus
    {
        ...
        public bool Equals(EventKey<TBus, TArg1, TArg2, TArg3> other) => Id == other.Id;

        public override bool Equals(object obj) =>
            obj is EventKey<TBus, TArg1, TArg2, TArg3> other && Equals(other);

        public override int GetHashCode() => Id;

        public static bool operator ==(EventKey<TBus, TArg1, TArg2, TArg3> left,
            EventKey<TBus, TArg1, TArg2, TArg3> right) => left.Equals(right);
