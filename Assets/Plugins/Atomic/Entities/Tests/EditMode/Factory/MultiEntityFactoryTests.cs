...
//         {
//             // Arrange
//             var factory = new MultiEntityFactory<string, IEntity>();
//             var spyFactory = new EntityFactorySpy();
//
//             factory.Register("enemy", spyFactory);
//
//             // Act
...
//             Assert.AreSame(spyFactory.Created, result);
//         }
//
//         [Test]
...
//             // Arrange
//             var factory = new MultiEntityFactory<string, IEntity>();
//             factory.Register("npc", new EntityFactoryStub());
//
//             // Act
...
//         {
//             // Arrange
//             var kvp = new KeyValuePair<string, IEntityFactory<IEntity>>[]
//             {
//                 new("enemy", new EntityFactoryStub()),
//                 new("boss", new EntityFactoryStub())
//             };
//
//             var factory = new MultiEntityFactory<string, IEntity>(kvp);
//
//             // Act & Assert
...
//             {
//                 ["orc"] = new EntityFactoryStub(),
//                 ["goblin"] = new EntityFactoryStub()
//             };
//
//             var factory = new MultiEntityFactory<string, IEntity>(dict);
//
//             // Act
...
//         {
//             // Arrange
//             IReadOnlyDictionary<string, IEntityFactory<IEntity>> readonlyDict =
//                 new Dictionary<string, IEntityFactory<IEntity>>
//                 {
//                     ["dragon"] = new EntityFactoryStub()
//                 };
//
//             var factory = new MultiEntityFactory<string, IEntity>(readonlyDict);
//
//             // Act
...
//         {
//             // Arrange
//             var factory = new MultiEntityFactory<string, EntitySpy>();
//
//             // Act & Assert
//             Assert.DoesNotThrow(() =>
//             {
