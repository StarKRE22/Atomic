...
namespace Atomic.Entities
{
    public class TickableManagerTests
    {
        ...
        {
            // Arrange
            var updatable = new TickSourceSpy();
            TickableManager.Instance.Register(updatable);
        ...
        public IEnumerator Should_StopCallingAfterRemove()
        {
            ...
            TickableManager.Instance.Unregister(updatable);
        ...
        public IEnumerator ShouldIgnoreNullAdd()
        {
            ...
            TickableManager.Instance.Register(null);
        ...
        {
            TickableManager.Instance.Unregister(null);
            yield return null;
            Assert.Pass();
        }
        ...
        public IEnumerator ShouldNotAddDuplicate()
        {
            // Arrange
            var updatable = new TickSourceSpy();
            var manager = TickableManager.Instance;
            ...
            Assert.AreEqual(1, manager._sources.Count(it => Equals(it, updatable)));
            yield break;
        }
