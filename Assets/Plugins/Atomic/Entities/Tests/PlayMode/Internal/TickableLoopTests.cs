...
{
    public class TickableLoopTests
    {
        [UnityTest]
        public IEnumerator Should_Invoke_OnUpdate()
        {
            ...
            TickableLoop.Instance.Register(updatable);
        ...
        public IEnumerator Should_StopCallingAfterRemove()
        {
            ...
            TickableLoop.Instance.Unregister(updatable);
        ...
        public IEnumerator ShouldIgnoreNullAdd()
        {
            ...
            TickableLoop.Instance.Register(null);
        ...
        {
            TickableLoop.Instance.Unregister(null);
            yield return null;
            Assert.Pass();
        }
        ...
        public IEnumerator ShouldNotAddDuplicate()
        {
            // Arrange
            var updatable = new TickSourceDummy();
            var manager = TickableLoop.Instance;
