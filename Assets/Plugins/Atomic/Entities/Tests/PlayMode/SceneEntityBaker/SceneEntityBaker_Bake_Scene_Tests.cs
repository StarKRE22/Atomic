...
//             for (int i = 0; i < 3; i++)
//             {
//                 var go = new GameObject($"Baker_{i}", typeof(SceneEntityBakerTestDouble));
...
//
//             // Act
//             var baked = SceneEntityBakerTestDouble.Bake(_testScene);
//
...
//
//             // Act
//             var baked = SceneEntityBakerTestDouble.Bake(_testScene, includeInactive: false);
//
//             //Wait for destroy bakers:
//             yield return null;
//
...
//
//             // Act
//             var baked = SceneEntityBakerTestDouble.Bake(_testScene, includeInactive: true);
//
//             //Wait for destroy bakers:
//             yield return null;
//
