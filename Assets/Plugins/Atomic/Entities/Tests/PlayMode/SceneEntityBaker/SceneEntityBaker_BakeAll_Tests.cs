...
//             for (int i = 0; i < 3; i++)
//             {
//                 new GameObject($"Baker_{i}", typeof(SceneEntityBakerTestDouble));
//             }
//
//             yield return null; // allow frame to register GameObjects
//
//             // Act
//             var entities = SceneEntityBakerTestDouble.BakeAll();
//
...
//             Assert.AreEqual(0, Object.FindObjectsOfType<SceneEntityBakerTestDouble>().Length);
//         }
//
//         [UnityTest]
...
//         {
//             // Arrange
//             var go = new GameObject("InactiveBaker", typeof(SceneEntityBakerTestDouble));
//             go.SetActive(false);
//
//             yield return null; // allow frame to register GameObjects
//
//             // Act
//             var entities = SceneEntityBakerTestDouble.BakeAll(includeInactive: true);
//
//             //Wait for destroy bakers:
//             yield return null;
//
...
//
//             // Act
//             var entities = SceneEntityBakerTestDouble.BakeAll(includeInactive: false);
//
//             // Assert
//             Assert.AreEqual(0, entities.Length);
//             Assert.AreEqual(0, SceneEntityBakerTestDouble.CreateCallCount);
//             Assert.AreEqual(1, Object.FindObjectsOfType<SceneEntityBakerTestDouble>(true).Length);
//         }
//     }
// }