...
{
    /// <summary>
    /// Represents a disposable subscription handle to an <see cref="ITickSource"/>'s <see cref="ITickSource.OnLateTicked"/> event.
    /// </summary>
    /// <remarks>
    /// Allows temporarily reacting to late update ticks of an <see cref="ITickSource"/> instance.
    ...
    public readonly struct LateTickSubscription : IDisposable
    {
        ...
        /// Subscribes the specified callback to the <see cref="ITickSource.OnLateTicked"/> event of the provided source.
        /// </summary>
