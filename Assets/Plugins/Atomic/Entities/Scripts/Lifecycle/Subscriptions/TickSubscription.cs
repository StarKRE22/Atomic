...
{
    /// <summary>
    /// Represents a disposable subscription handle to an <see cref="ITickSource"/>'s <see cref="ITickSource.OnTicked"/> event.
    /// </summary>
    /// <remarks>
    /// Allows temporarily reacting to frame-based updates of an <see cref="ITickSource"/> instance.
    ...
    public readonly struct TickSubscription : IDisposable
    {
        ...
        /// Subscribes the specified callback to the <see cref="ITickSource.OnTicked"/> event of the provided source.
        /// </summary>
