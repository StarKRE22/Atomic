...
namespace Atomic.Entities
{
    ...
    public class ValueEntityTrigger<E> : IEntityTrigger<E> where E : IEntity
    {
        ...
        private void OnValueDeleted(IEntity entity, int key, object value) => _action.Invoke((E) entity);
        ...
        private void OnValueAdded(IEntity entity, int key, object value) => _action.Invoke((E) entity);
        ...
        private void OnValueChanged(IEntity entity, int key, object value) => _action.Invoke((E) entity);
    }
}