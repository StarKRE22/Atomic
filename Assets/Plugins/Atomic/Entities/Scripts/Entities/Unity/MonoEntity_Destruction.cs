...
namespace Atomic.Entities
{
    ...
    {
        /// <summary>
        /// Destroys the associated GameObject of the specified <see cref="IEntity"/> if it can be cast to a <see cref="MonoEntity"/>.
        /// </summary>
        ...
        /// <summary>
        /// Destroys the specified <see cref="MonoEntity"/>'s GameObject after an optional delay.
        /// </summary>
        /// <param name="entity">The <see cref="MonoEntity"/> to destroy.</param>
        /// <param name="t">Optional delay in seconds before destruction. Defaults to 0.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
