...
{
    internal static class SceneEntityBakerOptimizedGenerator
    {
        ...
        private static string GenerateContent(string entityType, string entityInterface, string ns, string[] imports)
        {
            ...
            sb.AppendLine($"    public abstract class {entityType}Baker : SceneEntityBakerOptimized<{entityInterface}Entity, {entityType}View>");
            sb.AppendLine("    {");
            sb.AppendLine("    }");
            sb.AppendLine("}");
