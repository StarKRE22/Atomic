...
namespace Atomic.Entities
{
    internal static class EntityViewPoolGenerator
    {
        ...
        private static string GenerateContent(string entityType, string interfaceType, string ns, string[] imports)
        {
            ...
            sb.AppendLine($"    /// Provides a pooled manager for <see cref=\"{entityType}View\"/> instances bound to <see cref=\"{interfaceType}\"/> entities.");
            sb.AppendLine("    /// </summary>");
            sb.AppendLine("    /// <remarks>");
            sb.AppendLine("    /// This class is auto-generated by <b>Entity Domain Generator</b>.");
            sb.AppendLine($"    /// It inherits from <see cref=\"EntityViewPool{{TEntity, TView}}\"/> and is specialized for <see cref=\"{entityType}\"/>.");
            sb.AppendLine("    /// </remarks>");
