...
namespace Atomic.Extensions
{
    public static partial class Extensions
    {
        public static void AppendBy(
            ...
            IEntityPredicateAsset[] conditions,
            IEntity obj
        )
        {
            if (conditions == null)
            ...
            {
                IEntityPredicateAsset creator = conditions[i];
                if (creator != null)
                {
        ...
        public static void AppendBy<T>(
            ...
            IReadOnlyCollection<IEntityPredicateAsset<T>> conditions,
            IEntity entity
        )
        {
            if (conditions == null)
        ...
        public static void AppendBy<T>(
            this IExpression<T, bool> expression,
            IReadOnlyCollection<IEntityPredicateAsset> conditions,
            IEntity obj
        )
        {
            if (conditions == null)
