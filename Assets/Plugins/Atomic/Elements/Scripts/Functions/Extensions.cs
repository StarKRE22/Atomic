...
namespace Atomic.Elements
{
    ...
    {
        /// <summary>
        /// Wraps a <see cref="Func{R}"/> into a <see cref="BaseFunction{R}"/>.
        /// </summary>
        /// <typeparam name="R">The return type of the function.</typeparam>
        /// <param name="func">The function to wrap.</param>
        /// <returns>A <see cref="BaseFunction{R}"/> that wraps the provided delegate.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BaseFunction<R> AsFunction<R>(this Func<R> func) => new(func);

        /// <summary>
        /// Wraps a function with one parameter and a context object into a <see cref="BaseFunction{R}"/>.
        /// </summary>
        ...
        /// <returns>A <see cref="BaseFunction{R}"/> that wraps the contextual invocation.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <returns>A <see cref="BaseFunction{Boolean}"/> that returns the inverse of the current value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BaseFunction<bool> AsNot(this IFunction<bool> it) => new(() => !it.Invoke());
    }
}
