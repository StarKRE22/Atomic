...
namespace Atomic.Elements
{
    ...
    public class Expression<T, R> : ExpressionBase<T, R>
    {
        ...
        public Expression(Func<IReadOnlyList<Func<T, R>>, T, R> function) => this.function = function;
        ...
        public Expression(Func<IReadOnlyList<Func<T, R>>, T, R> function, IEnumerable<Func<T, R>> members)
            : base(members) => this.function = function;

        protected override R Invoke(IReadOnlyList<Func<T, R>> members, T arg) => this.function.Invoke(members, arg);
    }
    ...
    public class Expression<T1, T2, R> : ExpressionBase<T1, T2, R>
    {
        ...
        public Expression(Func<IReadOnlyList<Func<T1, T2, R>>, T1, T2, R> function) => this.function = function;
