...
namespace Atomic.Elements
{
    ...
    public abstract class ExpressionBase<R> : IExpression<R>
    {
        ...
        public ExpressionBase() => this.members = new List<Func<R>>();

        public ExpressionBase(params Func<R>[] members) => this.members = new List<Func<R>>(members);

        public ExpressionBase(IEnumerable<Func<R>> members) => this.members = new List<Func<R>>(members);
    ...
    public abstract class ExpressionBase<T, R> : IExpression<T, R>
    {
        ...
        public ExpressionBase() => this.members = new List<Func<T, R>>();

        public ExpressionBase(params Func<T, R>[] members) => this.members = new List<Func<T, R>>(members);

        public ExpressionBase(IEnumerable<Func<T, R>> members) => this.members = new List<Func<T, R>>(members);
    ...
    public abstract class ExpressionBase<T1, T2, R> : IExpression<T1, T2, R>
    {
        ...
        public ExpressionBase() => this.members = new List<Func<T1, T2, R>>();
