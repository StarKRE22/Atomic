...
//         public InlineExpression(Func<IReadOnlyList<Func<R>>, R> function) =>
//             this.function = function;
//
//         /// <summary>
//         /// Initializes a new instance of the <see cref="InlineExpression{R}"/> class with a custom evaluation function and initial members.
//         /// </summary>
...
//         public InlineExpression(Func<IReadOnlyList<Func<R>>, R> function, params Func<R>[] members)
//             : base(members) =>
//             this.function = function;
//
//         /// <summary>
...
//         public InlineExpression(Func<IReadOnlyList<Func<R>>, R> function, IEnumerable<Func<R>> members)
//             : base(members) =>
//             this.function = function;
//
//         /// <summary>
...
//         public InlineExpression(Func<IReadOnlyList<Func<T, R>>, T, R> function) =>
//             this.function = function;
//
//         /// <summary>
...
//         public InlineExpression(Func<IReadOnlyList<Func<T, R>>, T, R> function, params Func<T, R>[] members)
//             : base(members) =>
//             this.function = function;
//
//         /// <summary>
...
//         public InlineExpression(Func<IReadOnlyList<Func<T, R>>, T, R> function, IEnumerable<Func<T, R>> members)
//             : base(members) =>
//             this.function = function;
//
//         /// <summary>
