...
namespace Atomic.Elements
{
    ...
    public static partial class Extensions
    {
        ...
        // /// <param name="member">The function object to add.</param>
        // [MethodImpl(MethodImplOptions.AggressiveInlining)]
        // public static void AddLast<R>(this IExpression<Func<R>, R> it, IFunction<R> member) =>
        ...
        // [MethodImpl(MethodImplOptions.AggressiveInlining)]
        // public static void Remove<R>(this IExpression<Func<R>, R> it, IFunction<R> member) =>
