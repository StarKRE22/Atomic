...
namespace Atomic.Elements
{
    ...
    public abstract class ExpressionBase<R> : IExpression<R>
    {
        ...
        /// </summary>
        protected ExpressionBase() => this.members = new List<Func<R>>();
        ...
        protected ExpressionBase(params Func<R>[] members) => this.members = new List<Func<R>>(members);

        /// <summary>
        /// Initializes the expression with the specified function members.
        /// </summary>
        /// <param name="members">A collection of functions to initialize the expression with.</param>
        protected ExpressionBase(IEnumerable<Func<R>> members) => this.members = new List<Func<R>>(members);
