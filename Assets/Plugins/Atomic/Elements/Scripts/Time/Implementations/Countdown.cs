...
{
    [Serializable]
    public class Countdown : IPlayable, IPausable, IEndable, IProgressable, ITickable
    {
        public enum State
        {
            IDLE = 0,
    ...
    [Serializable]
    public class Countdown<T> : IPlayable<T>, IPausable, IEndable<T>, IProgressable, ITickable, IValue<T>
    {
        public enum State
        {
            IDLE = 0,
