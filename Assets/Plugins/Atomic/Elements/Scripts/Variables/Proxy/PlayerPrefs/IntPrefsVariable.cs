...
{
    /// <summary>
    /// A variable that persists its int value in Unity's <see cref="PlayerPrefs"/>.
    /// Simply implements <see cref="IVariable{int}"/> without reactive subscriptions.
    /// </summary>
    [Serializable]
    public sealed class IntPrefsVariable : IVariable<int>
    {
        /// <summary>
        ...
        public int Value
        {
            ...
            set => PlayerPrefs.SetInt(this.key, value);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IntPrefsVariable"/> class.
        /// </summary>
