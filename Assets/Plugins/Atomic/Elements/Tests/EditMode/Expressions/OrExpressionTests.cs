...
namespace Atomic.Elements
{
    public sealed class OrExpressionTests
    {
        ...
        public void EmptyExpression()
        {
            ...
            //Assert:
            Assert.AreEqual(0, orExpression.MemberCount);
        ...
        public void TrueExpression()
        {
            ...
            //Assert:
            Assert.AreEqual(2, orExpression.MemberCount);
        ...
        public void Remove()
        {
            ...
            //Assert:
            Assert.AreEqual(1, orExpression.MemberCount);
            Assert.IsFalse(orExpression.Value);
    ...
    public sealed class OrExpressionT1Tests
    {
        ...
        public void FalseExpression()
        {
            ...
            //Assert:
            Assert.AreEqual(3, orExpression.MemberCount);
            Assert.IsFalse(orExpression.Invoke("Vasya"));
        }
