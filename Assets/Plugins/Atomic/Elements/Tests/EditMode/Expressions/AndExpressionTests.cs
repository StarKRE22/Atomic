...
namespace Atomic.Elements
{
    ...
    public sealed class AndExpressionTests
    {
        ...
        public void EmptyExpression()
        {
            ...
            //Assert:
            Assert.AreEqual(0, andExpression.Count);
        ...
        public void Add()
        {
            ...
            andExpression.Add(Consts.False);
        ...
        public void Remove()
        {
            ...
            //Assert:
            Assert.IsTrue(andExpression.Value);
            Assert.AreEqual(1, andExpression.Count);
    ...
    public sealed class AndExpressionT1Tests
    {
        ...
        {
            //Arrange:
            var andExpression = new AndExpression<string>(_ => true
            );
    ...
    public sealed class AndExpressionT2Tests
    {
        ...
        {
            //Arrange:
            var andExpression = new AndExpression<string, int>((s, i) => true
            );
