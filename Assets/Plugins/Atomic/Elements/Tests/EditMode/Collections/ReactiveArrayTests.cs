...
namespace Atomic.Elements
{
    ...
    public sealed class ReactiveArrayTests
    {
        ...
        public void SetAll_NullInput_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => array.SetAll(null));
        }
        ...
        public void SetAll_TooFewElements_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => array.SetAll(new[] {1, 2}));
        }
        ...
        public void SetAll_TooManyElements_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => array.SetAll(new[] {1, 2, 3}));
        }
