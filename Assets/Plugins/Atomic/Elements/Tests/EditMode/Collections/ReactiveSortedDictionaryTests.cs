...
{
    [TestFixture]
    public sealed class ReactiveSortedDictionaryTests
    {
        [Test]
        public void Instantiate()
        {
            //Arrange:
            var dictionary = new ReactiveSortedDictionary<string, int>
            {
                {"Milk", 5},
                {"Bread", 3},
                {"Butter", 2}
        ...
        public void WhenGetAbsentKeyThenThrowsKeyNotFoundException()
        {
            ...
            {
                int _ = new ReactiveSortedDictionary<string, int>()["Milk"];
            });
        }
        ...
        {
            Assert.Catch<ArgumentException>(() => new ReactiveSortedDictionary<string, int>
            {
                {"Milk", 5}
            }.Add("Milk", 3));
        }
        ...
        public void OnBeforSerialize()
        {
            ...
            //Assert:
            var pairs = typeof(ReactiveSortedDictionary<string, int>)
                .GetField("pairs", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.DeclaredOnly)!
                .GetValue(dictionary) as ReactiveSortedDictionary<string, int>.Pair[];

            Assert.AreEqual(new ReactiveSortedDictionary<string, int>.Pair[]
            {
        ...
        public void OnAfterDeserialize()
        {
            ...
            typeof(ReactiveSortedDictionary<string, int>)
                .GetField("pairs", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.DeclaredOnly)!
                .SetValue(dictionary, new ReactiveSortedDictionary<string, int>.Pair[]
                {
                    new() {key = "Milk", value = 5},
                    new() {key = "Bread", value = 3},
                    new() {key = "Butter", value = 2},
